...
To build the final jar and optimize the rfidNoDbElk application for production, run:
...
Then navigate to [http://localhost:9194](http://localhost:9194) in your browser.
